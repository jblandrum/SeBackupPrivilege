...
namespace bz.OneOEight.SeBackupPrivilege
{
	public class SeBackupPrivilegeUtils
	{
		...
		public static bool setSeRestorePrivilege(bool enable)
		{
			bool retVal;
			TokPriv1Luid tp;
			IntPtr htok = IntPtr.Zero;
			...
			if (!LookupPrivilegeValue(null, "SeRestorePrivilege", ref tp.Luid))
			{
				croak("LookupPrivilegeValue");
			}
			retVal = AdjustTokenPrivileges(htok, false, ref tp, 0, IntPtr.Zero, IntPtr.Zero);
		...
		public static bool isSeRestorePrivilegeEnabled()
		{
			bool retVal;
			IntPtr htok = IntPtr.Zero;
			TokPriv1Luid tp;
		...
		public static bool CopyFileSeBackup(string inFileName, string outFileName, ref uint bytesCopied, bool overwrite) {
			IntPtr inFile;
			IntPtr outFile;
			inFile = CreateFile(
				inFileName,
		...
		public static bool CopyFileSeRestore(string inFileName, string outFileName, ref uint bytesCopied, bool overwrite)
		{
			IntPtr inFile;
			IntPtr outFile;
			inFile = CreateFile(
		...
		public static bool CopyFileNeitherDACL(string inFileName, string outFileName, ref uint bytesCopied, bool overwrite)
		{
			IntPtr inFile;
			IntPtr outFile;
			inFile = CreateFile(
